...
my $adjustIndex = qr/([\d]+)/;
#my $adjustline = qr/\A\s*adjustable\s*,\s*${mylabel}\s*,\s*${mylabel}\s*:\s*${adjustIndex}\s*;\s*$/;
my $guiDefn = qr/(.+)/;
my $adjustline = qr/\A\s*adjustable\s*,\s*${mylabel}\s*,\s*${mylabel}\s*:\s*${adjustIndex}\s*,\s*${guiDefn}\s*;\s*$/;
