...
BaseConnector::BaseConnector(ObjController& owner_)
    :
    owner(owner_),
...
void BaseConnector::paint(Graphics& g)
{
    if(! isVisible())
        return;
...
void BaseConnector::resizeToFit()
{
    float x1, y1, x2, y2;
    getPoints(x1, y1, x2, y2);
...
bool BaseConnector::hitTest(int x, int y)
{
...
void BaseConnector::mouseDown(const MouseEvent& e)
{
...
void BaseConnector::mouseDrag(const MouseEvent& /*e*/)
{
...
Rectangle<int> BaseConnector::getIntersectioBounds()
{
